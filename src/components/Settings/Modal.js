          ...
          <div className="itemModal--content">
            ...
            <div>
              <input
                ...
                id="id"
                name="id"
                defaultValue={selectedDsn.id}
              ></input>
              <input
                type="text"
                id="dsn_prefix"
                name="dsn_prefix"
                defaultValue={selectedDsn.dsn_prefix}
              ></input>
              <input
                type="text"
                id="comm_prefix"
                name="comm_prefix"
                defaultValue={selectedDsn.comm_prefix}
              ></input>
              <input
                type="text"
                id="description"
                name="description"
                defaultValue={selectedDsn.description}
              ></input>
              <Select
                id="location"
                name="location"
                defaultValue={{
                  label: selectedDsn.location,
                  value: selectedDsn.location_id,
                }}
                options={setDSNApi.locationList}
              />
            </div>
          </div>
        </form>
