//Main interface to update DSNs in the database.  Requires Auth0 authentication.
...
export default function Settings() {
  ...
  const currentItems = itemList
    ? itemList.slice(indexOfFirstItem, indexOfLastItem)
    : {};
      ...
      {isAuthenticated && (
        <>
          <SettingsContext.Provider value={setDSNApi}>
            <div>
              <ShowList itemList={currentItems} loading={loading} />
              <Pagination
            ...
            <Modal openModal={openModal} selectedDsn={selectedDsn}></Modal>
